...
public class GepardParser implements GepardParserConstants {
        public static void main(String args[]) {
                ...
                try{
                        System.out.println(parser.InsertTable());
                }catch(Exception e){
...
// General Semantics
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10060,0x2000000,0x20000800,0x1008000,0x10000000,0x2000000,0x10000000,0x10000000,0x300,0x6000,0x400,0x40000,0x2000000,0x70000000,0x70000000,0x10000000,0x14000000,};
   }
